...
try {
    ...
    Assert-True ($updatedState.templateVersion -eq '1.5.7') 'Managed state should record the new template version.'
    ...
    Assert-True ($enrolledState.templateVersion -eq '1.5.7') 'Initial enrolment should record the current template version.'
