...
try {
    ...
    Assert-True ($updatedState.templateVersion -eq '1.5.5') 'Managed state should record the new template version.'
    ...
    Assert-True ($enrolledState.templateVersion -eq '1.5.5') 'Initial enrolment should record the current template version.'
